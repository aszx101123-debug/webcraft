...
const ITEM = Object.freeze({
  ...
  WOODEN_PICKCUTTER: 200, STONE_PICKCUTTER: 201, IRON_PICKCUTTER: 202, GOLD_PICKCUTTER: 203, DIAMOND_PICKCUTTER: 204,
...
const ITEMS = {
  ...
  [ITEM.WOODEN_PICKCUTTER]: toolItem(ITEM.WOODEN_PICKCUTTER, '나무 곡괭이', 'pickaxe', 1, 2, 60, [1, 5]),
  [ITEM.STONE_PICKCUTTER]: toolItem(ITEM.STONE_PICKCUTTER, '돌 곡괭이', 'pickaxe', 2, 4, 132, [2, 5]),
  [ITEM.IRON_PICKCUTTER]: toolItem(ITEM.IRON_PICKCUTTER, '철 곡괭이', 'pickaxe', 3, 6, 250, [3, 5]),
  [ITEM.GOLD_PICKCUTTER]: toolItem(ITEM.GOLD_PICKCUTTER, '금 곡괭이', 'pickaxe', 4, 10, 33, [4, 5]),
  [ITEM.DIAMOND_PICKCUTTER]: toolItem(ITEM.DIAMOND_PICKCUTTER, '다이아몬드 곡괭이', 'pickaxe', 5, 8, 1562, [5, 5]),
