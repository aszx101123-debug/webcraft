...
const BLOCK = Object.freeze({
  ...
  CRAFTING_TABLE: 14, COAL_ORE: 15, IRON_ORE: 16, GOLD_ORE: 17, DIAMOND_ORE: 18, BED: 19
});
...
const BLOCKS = [
  ...
  { name: '제작대',    tiles: { top: [1, 1], side: [1, 0], bottom: [2, 0] } },
  { name: '석탄 광석', tiles: { all: [0, 3] } },
  { name: '철 광석',   tiles: { all: [1, 3] } },
  { name: '금 광석',   tiles: { all: [2, 3] } },
  { name: '다이아몬드 광석', tiles: { all: [3, 3] } },
  { name: '침대',      tiles: { all: [5, 3] } }
];

const ITEM = Object.freeze({
  PORK: 100, BEEF: 101, CHICKEN: 102, MUTTON: 103, ROTTEN: 104, APPLE: 105,
  STICK: 106, WOOD_PICKAXE: 107, STONE_PICKAXE: 108, WOOD_AXE: 109, STONE_AXE: 110,
  WOOD_SHOVEL: 111, STONE_SHOVEL: 112, COAL: 113, RAW_IRON: 114, RAW_GOLD: 115,
  DIAMOND: 116, IRON_PICKAXE: 117, DIAMOND_PICKAXE: 118, DIAMOND_AXE: 119,
  DIAMOND_SHOVEL: 120, DIAMOND_SWORD: 121, WOOL: 122
});
...
const BLOCK_HARDNESS = {
  ...
  [BLOCK.COAL_ORE]: 1.8, [BLOCK.IRON_ORE]: 2.2, [BLOCK.GOLD_ORE]: 2.2,
  [BLOCK.DIAMOND_ORE]: 3.0, [BLOCK.BED]: .25, [BLOCK.GLOWSTONE]: .9,
  [BLOCK.WATER]: .2, [BLOCK.CRAFTING_TABLE]: 1.8, [BLOCK.BEDROCK]: Infinity
};
...
function getMiningToolMultiplier(blockId, toolId) {
  ...
  const pickaxeBlocks = [
    BLOCK.STONE, BLOCK.COBBLE, BLOCK.BRICK, BLOCK.GLASS,
  ...
  const valid = t.type !== 'sword' && preferred && t.tier >= requiredTier;
...
const PLACEABLE_IDS = [
  ...
  BLOCK.CRAFTING_TABLE, BLOCK.COAL_ORE, BLOCK.IRON_ORE, BLOCK.GOLD_ORE, BLOCK.DIAMOND_ORE, BLOCK.BED
];
...
function isFoodId(id) {
  return id >= 100 && !!ITEMS[id] && !!ITEMS[id].food;
}
...
function isTargetableBlock(id) {
  return id !== BLOCK.AIR && id !== BLOCK.WATER && !!BLOCKS[id];
}
