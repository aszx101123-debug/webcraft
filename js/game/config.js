...
const BLOCKS = [
  ...
  { name: '통나무',    tiles: { top: [7, 0], side: [6, 0], bottom: [7, 0] }, miningTime: .78, tool: 'axe' },
  { name: '잎',        tiles: { all: [0, 1] }, cutout: true, miningTime: .16, tool: 'hoe' },
  { name: '판자',      tiles: { all: [1, 1] }, miningTime: .62, tool: 'axe' },
  ...
  { name: '제작대',    tiles: { top: [6, 6], side: [7, 6], bottom: [6, 7] }, miningTime: .8, tool: 'axe' },
...
const ITEM = Object.freeze({
  ...
  WOODEN_AXE: 205, STONE_AXE: 206, IRON_AXE: 207, GOLD_AXE: 208, DIAMOND_AXE: 209,
...
const ITEMS = {
  ...
  [ITEM.WOODEN_AXE]: toolItem(ITEM.WOODEN_AXE, '나무 도끼', 'axe', 1, 2, 60, [6, 5]),
  [ITEM.STONE_AXE]: toolItem(ITEM.STONE_AXE, '돌 도끼', 'axe', 2, 4, 132, [7, 5]),
  [ITEM.IRON_AXE]: toolItem(ITEM.IRON_AXE, '철 도끼', 'axe', 3, 6, 250, [0, 6]),
  [ITEM.GOLD_AXE]: toolItem(ITEM.GOLD_AXE, '금 도끼', 'axe', 4, 10, 33, [1, 6]),
  [ITEM.DIAMOND_AXE]: toolItem(ITEM.DIAMOND_AXE, '다이아몬드 도끼', 'axe', 5, 8, 1562, [2, 6]),
